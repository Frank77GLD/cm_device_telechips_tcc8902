...
#
PRODUCT_NAME := cyanogen_m1001
PRODUCT_BRAND := telechips
PRODUCT_DEVICE := tcc8902
PRODUCT_MODEL := Haipad M1001
PRODUCT_MANUFACTURER := Haina
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=m1001 BUILD_ID=GRJ22 BUILD_DISPLAY_ID=GRJ22 BUILD_FINGERPRINT=google/soju/crespo:2.3.4/GRJ22/121341:user/release-keys PRIVATE_BUILD_DESC="soju-user 2.3.4 GRJ22 121341 release-keys" BUILD_NUMBER=121341
