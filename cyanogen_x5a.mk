...
$(call inherit-product, device/telechips/tcc8902/nosensors_tcc8902.mk)
...
#
PRODUCT_NAME := cyanogen_x5a
PRODUCT_BRAND := telechips
PRODUCT_DEVICE := tcc8902
PRODUCT_MODEL := X5A
PRODUCT_MANUFACTURER := HSG
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=x5a BUILD_ID=GRK39F BUILD_DISPLAY_ID=GWK74 BUILD_FINGERPRINT=google/soju/crespo:2.3.6/GRK39F/189904:user/release-keys PRIVATE_BUILD_DESC="soju-user 2.3.6 GRK39F 189904 release-keys" BUILD_NUMBER=189904
